...
INSERT INTO `sys_gl_qx` VALUES ('ac66961adaa2426da4470c72ffeec117', '1', '1', '1', '0', '1', '0', '0');
...
INSERT INTO `sys_menu` VALUES ('22', '信息管理2', 'tb_er/list.do', '6', '2', null, '2');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理员', '8388598', '0', '1', '1', '1', '1', '1');
INSERT INTO `sys_role` VALUES ('2', '超级管理员', '8388598', '1', '8388598', '50', '8388598', '8388598', '2');
...
INSERT INTO `sys_role` VALUES ('7dfd8d1f7b6245d283217b7e63eec9b2', '管理员B', '8388598', '1', '246', '0', '0', '8388598', '7dfd8d1f7b6245d283217b7e63eec9b2');
INSERT INTO `sys_role` VALUES ('ac66961adaa2426da4470c72ffeec117', '管理员A', '8388598', '1', '54', '54', '0', '246', 'ac66961adaa2426da4470c72ffeec117');
...
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', '系统管理员', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2017-06-13 11:29:11', '0:0:0:0:0:0:0:1', '0', '最高统治者', 'default', 'admin@main.com', '001', '18788888888');
...
INSERT INTO `sys_user` VALUES ('91db08821ff14a78be47d685876c8792', 'test', '51abb9636078defbf888d8457a7c76f85c8f114c', 'test', '', '2', '2017-06-13 09:19:35', '0:0:0:0:0:0:0:1', '0', '', 'default', '1023510862@qq.com', 'test', '18682093987');
INSERT INTO `sys_user` VALUES ('b825f152368549069be79e1d34184afa', 'san', '47c4a8dc64ac2f0bb46bbd8813b037c9718f9349', '三', '', '2', '2015-08-03 14:18:14', '127.0.0.1', '0', 'sdfsdgf', 'default', 'sdfsdf@qq.com', 'sdsaw22', '18682093987');
INSERT INTO `sys_user` VALUES ('e00e938db9344f0db1abbc20b5c9a2ce', 'wang', '60d8dd050bb2dbccdd1593dc4add1fae43191519', 'w', '', '2', '2017-06-12 17:54:54', '0:0:0:0:0:0:0:1', '0', '123', 'default', '1023510862@qq.com', '105', '18682093987');
...
-- ----------------------------
-- Table structure for tb_tb_er
-- ----------------------------
DROP TABLE IF EXISTS `tb_tb_er`;
CREATE TABLE `tb_tb_er` (
  `TB_ER_ID` varchar(100) NOT NULL,
  `W` varchar(255) DEFAULT NULL COMMENT 'q',
  PRIMARY KEY (`TB_ER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_tb_er
-- ----------------------------
INSERT INTO `tb_tb_er` VALUES ('a10837e8929142d98ed13fbc5263fbd6', 'qwuytr');
